...
### UGANDA ###
setwd("/home/bk249/groups/grp_tb/uganda_nasal_cells-main")
...
setwd("/grphome/grp_tb/processing_scripts/results/fisher_method")

write.csv(merged_data_clean, file = "top_genes.csv")